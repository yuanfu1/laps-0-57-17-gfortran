...
!       Dummy arguments
        integer i4time, imax, jmax, istatus
        character*(*) EXT
...
!       Temporary arrays for READ_LAPS_DATA
        character*3 tmp_var_2d(1)
        integer tmp_lvl_2d(1)
        character*4 tmp_lvl_coord_2d(1)
        character*10 tmp_units_2d(1)
        character*125 tmp_comment_2d(1)
...
11      format(' Reading 2d ',a,1x,a,1x,a,1x,a)
        ...
        lvl_coord_2d = 'MSL'
            ...
            !           Copy scalars to arrays for READ_LAPS_DATA
            tmp_var_2d(1) = var_2d
            tmp_lvl_2d(1) = lvl_2d
            tmp_lvl_coord_2d(1) = lvl_coord_2d
            tmp_units_2d(1) = units_2d
            tmp_comment_2d(1) = comment_2d

        CALL READ_LAPS_DATA(I4TIME,DIRECTORY,EXT,imax,jmax,
     1                     1,1,tmp_var_2d,tmp_lvl_2d,
     1                     tmp_lvl_coord_2d,tmp_units_2d,
     1                     tmp_comment_2d,field_2d,ISTATUS)

            !           Copy arrays back to scalars
            var_2d = tmp_var_2d(1)
            lvl_2d = tmp_lvl_2d(1)
            lvl_coord_2d = tmp_lvl_coord_2d(1)
            units_2d = tmp_units_2d(1)
            comment_2d = tmp_comment_2d(1)
...
11      format(' Reading 2d ',a,1x,a5,1x,a3)
     ...
     1,imax,jmax,1,1,VAR_2D,LVL_2D,LVL_COORD_2D,tmp_units_2d
...
!       Dummy arguments
        integer i4time_needed, i4tol, i4time_nearest
        integer imax, jmax, ilevel, istatus
        character*(*) EXT_IN
        character*125 comment_2d
        character*10 units_2d
        character*3 var_2d
...
!       Local variables
        ...
        character*120 satdir
        integer i4times(max_files)
        integer i_selected(max_files)
        integer i, j, n_files_ret, lenext, len_dir
        integer i4_diff,i4_diff_min,i_nbr_files_ret,il,jl
        real r_missing_data, range_max
        integer LVL_2d, k
        real zcoord_of_level
        character*4 LVL_COORD_2d
...
11              format(' Reading 2d ',a,1x,a9,1x,a5,1x,a3)
     ...
     1            ,jmax,1,1,tmp_var_2d,tmp_lvl_2d,
     1            tmp_lvl_coord_2d,tmp_units_2d,
     1            tmp_comment_2d,field_2d,ISTATUS)
...
11      format(' Reading 3d ',a,1x,a5,1x,a3)
     ...
     1                     COMMENT_3D,field_3d,ISTATUS)
          ...
          CALL READ_LAPS(I4TIME,i4_valid,DIRECTORY,EXT_INT
     1,imax,jmax,1,1,VAR_3D,LVL_3D,LVL_COORD_3D,tmp_units_2d
...
!       Dummy arguments
        ...
        integer i4time_needed, i4tol, i4time_nearest, i4time_sys
        character*125 comment_2d
        character*10 units_2d
        character*3 var_2d
...
!       Local variables
        ...
        integer i_selected(max_files)
        logical lcont
        integer i, j, ldir, lext, n_files_ret
        integer i_nbr_files_ret,il,jl,lsdir
        integer i4_diff, i4_diff_min, i4_diff_sys
        integer i4_diff_min_sys,i4diffmn,istat
        integer nfield
...
c
        ...
        if(jf.gt.1)then
           ...
           if(jr.gt.1)then
              i4_diff_min=1000.
              do i=1,jr
                 i4_diff=abs(i4times_data(i)-i4time_needed)
                 if(i4_diff.lt.i4diffmn)then
                    jf=i
                    i4_diff_min=i4_diff
                 endif
              enddo
