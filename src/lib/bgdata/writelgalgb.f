...
c     .,rp_sfc,pcp_sfc,cw_sfc,istatus)
...
c        endif
      ...
      comment(1)=cmodel(1:ic)//' interpolated to LAPS surface.'
...
c --- U
     ...
     +              then
      ...
      print*,'USF'
      call write_laps(bgtime,bgvalid,outdir,ext
     .           ,nx_laps,ny_laps,1,1,var,ip,lvl_coord
...
c --- T
     ...
     +              then
      ...
      var(1)='TSF'
      print*,'TSF'
      comment(1)=cmodel(1:ic)//' 2-m Temp FG'
      call write_laps(bgtime,bgvalid,outdir,ext
     .           ,nx_laps,ny_laps,1,1,var,ip,lvl_coord
...
c --- T at Sfc
     ...
     +              then
      ...
      var(1)='TGD'
      print*,'TGD'
      comment(1)=cmodel(1:ic)//' Ground Temp FG'
      call write_laps(bgtime,bgvalid,outdir,ext
     .           ,nx_laps,ny_laps,1,1,var,ip,lvl_coord
...
c --- Precipitation 
     ...
     +              then
      ...
      enddo
      var(1)='PCP'
      units(1)='mm' ! modified units ( k/m**2 -> mm ) by Wei-Ting (130312)
      print*,'PCP'
      call write_laps(bgtime,bgvalid,outdir,ext
     .           ,nx_laps,ny_laps,1,1,var,ip,lvl_coord
