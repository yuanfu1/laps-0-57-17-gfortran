...
!$$$
      ...
      integer,allocatable :: coordieee_int(:)
      ...
      if ( numcoord .ne. 0 ) then
        allocate (coordieee_int(numcoord))
        allocate (coordieee(numcoord))
        call gbytes(cgrib,coordieee_int,iofst,32,0,numcoord)
        coordieee = transfer(coordieee_int, coordieee)
        call rdieee(coordieee,coordlist,numcoord)
        deallocate (coordieee_int)
