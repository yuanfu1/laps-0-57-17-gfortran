...
! Yuanfu added n_levels and c_levels to call write_laps_lfm for fsf.
! The original code use constants in their places which caused 
! segmentation faults
integer n_levels
real c_levels
...
! Yuanfu Xie replaces 1,0. in the following call to avoid segmentation fault
! as write_laps_lfm will assign a value to the argument of n_levels. As their
! use of 1 in that place, the assignment inside write_laps_lfm will cause
! segmentation.
n_levels = 1
c_levels = 0.0
call write_laps_lfm(laps_reftime,laps_valtime,trim(output_dir),cdl_dir  &
                   ...
                   ! ,units2d,com2d,1,0.                                  &  
                   ,units2d,com2d,n_levels,c_levels                     &  
                   ,sgrid,istatus)
