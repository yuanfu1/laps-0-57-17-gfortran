...
C
     ...
     +     firstOverflow(1), globalInventory(1), indxRefr( rawLevel,
     ...
     +     nStaticIds(1), oiMan( manLevel, recNum), optIndxRefr(
...
C
      ...
      nf_status=NF_GET_VAR_INT(nf_fid,nf_vid,firstOverflow(1))
      if(nf_status.ne.NF_NOERR) then
        print *, NF_STRERROR(nf_status)
        print *,'in var firstOverflow'
      endif
...
C
      ...
      nf_status=NF_GET_VAR_INT(nf_fid,nf_vid,globalInventory(1))
      if(nf_status.ne.NF_NOERR) then
        print *, NF_STRERROR(nf_status)
        print *,'in var globalInventory'
      endif
...
C
      ...
      nf_status=NF_GET_VAR_INT(nf_fid,nf_vid,nStaticIds(1))
      if(nf_status.ne.NF_NOERR) then
        print *, NF_STRERROR(nf_status)
        print *,'in var nStaticIds'
      endif
