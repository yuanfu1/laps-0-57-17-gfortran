...
#   ln -s $LAPS_DATA_ROOT/lapsprd                 $WRFDIR/lapsprd
  ...
  echo   RCTIME `/usr/bin/perl $LAPSINSTALLROOT/etc/systime.pl $RYY $RMON $RDD $RHH $RMM | head -1` 
  setenv RCTIME `/usr/bin/perl $LAPSINSTALLROOT/etc/systime.pl $RYY $RMON $RDD $RHH $RMM | head -1` 
