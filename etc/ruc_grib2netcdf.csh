...
setenv NCGEN /opt/homebrew/bin/ncgen
setenv TZ GMT
set installroot=$1
set dataroot=$2
...
if (! -e $installroot/ruc_hyb_A236_ITS.cdl) then
    echo "ERROR: file $installroot/ruc_hyb_A236_ITS.cdl not found..."
    exit
endif
...
foreach time ( * )
   ...
   echo "$installroot/Grib2NetCDF -p ruc236 -l $dataroot -c $installroot/ruc_hyb_A236_ITS.cdl -f $dataroot/grib/$time -o $dataroot/netcdf -v"	
   $installroot/Grib2NetCDF -p ruc236 -l $dataroot -c $installroot/ruc_hyb_A236_ITS.cdl -f $dataroot/grib/$time -o $dataroot/netcdf -v
end
