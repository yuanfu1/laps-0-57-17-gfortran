...
require "/Users/xiey/developments/da/laps/lapsinstallroot/etc/laps_tools.pm";
...
#       chdir "$public/data/grids/ruc/iso/grib2/";
    ...
    if (defined $opt_g) {
        ...
        system ("/bin/csh /Users/xiey/developments/da/laps/lapsinstallroot/etc/ruc_grib2netcdf.csh $opt_g $public/data/grids/ruc/hyb_A236");
        $t=gmtime(); 
...
#           system ("find -mindepth 1 -maxdepth 1 -name \"\*\.tar\.gz\" -exec gunzip {} \\;");
    ...
    if (defined $opt_g) {
        print $t." Degrib gfs\n";
        if (! -d $opt_g){ die "$opt_g not found! \n";}
        system ("/bin/csh /Users/xiey/developments/da/laps/lapsinstallroot/etc/ruc_grib2netcdf.csh $opt_g $public/data/grids/gfs");
        $t=gmtime(); 
    }
}	
