...
use lib "/Users/xiey/developments/da/laps/lapsinstallroot/etc/www"; # Path for 'cgi-lib.pl'
require "cgi-lib.pl";    # supplied in $LAPSINSTALLROOT/etc/www (formerly /w3/utilities)

use lib "/Users/xiey/developments/da/laps/lapsinstallroot/etc"; # Path for 'laps_tools.pm'
...
# my $image_type = "jpg";
  ...
  my $exedir;
  $exedir = "/Users/xiey/developments/da/laps/lapsinstallroot/bin";
...
#       system("/Users/xiey/developments/da/laps/lapsinstallroot/etc/www/lapsplot/lapsplot_gifs.sh $$ $window $request_root/lapsplot $delay_safe $exedir $laps_data_root allsky      $animate $zoom_safe 1> $web_root/$ScratchDir/lapsplot.out_$$ 2>&1"); 
        system("ssh oplapb\@dlaps-ms1.fsl.noaa.gov /Users/xiey/developments/da/laps/lapsinstallroot/etc/www/lapsplot/lapsplot_gifs.sh $$ $window $request_root/lapsplot $delay_safe $exedir $laps_data_root allsky      $animate $zoom_safe 1> $web_root/$ScratchDir/lapsplot.out_$$ 2>&1"); 
    }else{
#       system("/Users/xiey/developments/da/laps/lapsinstallroot/etc/www/lapsplot/lapsplot_gifs.sh $$ $window $request_root/lapsplot $delay_safe $exedir $laps_data_root $ncarg_root $animate $resolution 1> $web_root/$ScratchDir/lapsplot.out_$$ 2>&1"); 
        system("ssh oplapb\@dlaps-ms1.fsl.noaa.gov /Users/xiey/developments/da/laps/lapsinstallroot/etc/www/lapsplot/lapsplot_gifs.sh $$ $window $request_root/lapsplot $delay_safe $exedir $laps_data_root $ncarg_root $animate $resolution 1> $web_root/$ScratchDir/lapsplot.out_$$ 2>&1"); 
    }
