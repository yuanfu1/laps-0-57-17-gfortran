#!/usr/bin/perl
# Generated automatically from lfmpost.pl.in by configure.

require 5;
use strict;
require "/Users/xiey/developments/da/laps/lapsinstallroot/etc/laps_tools.pm";                 # supplied in $LAPSINSTALLROOT/etc
...
$LAPSROOT = "/Users/xiey/developments/da/laps/lapsinstallroot";
...
#        system ("/usr/local/esrl/bin/sgestat -why");
        ...
        if (defined ($opt_F)) { # Run followup to make GIFS 
          if (defined ($opt_n) && ! -d "w3/lapb") { # other conditions for this to work
            ...
            if ($fcst == 0) {
              my $purger = "/Users/xiey/developments/da/laps/lapsinstallroot/etc/purge_w3_fcst2d.pl -d $lapsdataroot -t 30 dummy $subdir\n";
              print "call purger\n";
              print "$purger\n";
              system("$purger");
            }
...
#           $date is yyyymmddhh of model initial time
            ...
            my $followup =       "/Users/xiey/developments/da/laps/lapsinstallroot/etc/www/followup_fcst.sh       dummy $subdir $lapsdataroot $window $resolution";
            $command = "$followup $modelfcsttime /Users/xiey/developments/da/laps/lapsinstallroot";
            print "running followup hsect command: $command";
            system ("$command");

            my $followup_xsect = "/Users/xiey/developments/da/laps/lapsinstallroot/etc/www/followup_fcst_xsect.sh dummy $subdir $lapsdataroot";
            $command = "$followup_xsect $modelfcsttime /Users/xiey/developments/da/laps/lapsinstallroot";
