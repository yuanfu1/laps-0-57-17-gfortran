...
use lib "/Users/xiey/developments/da/laps/lapsinstallroot/etc"; # Set this to your path for 'laps_tools.pm'
...
$ENV{LAPSINSTALLROOT}="/Users/xiey/developments/da/laps/lapsinstallroot";
my $dataroot = $opt_r;
...
my $followup = "/Users/xiey/developments/da/laps/lapsinstallroot/etc/www/followup_fcst.sh $domain $model $dataroot $window $resolution";
...
my $followup_xsect =  "/Users/xiey/developments/da/laps/lapsinstallroot/etc/www/followup_fcst_xsect.sh $domain $model $dataroot";
my $followup_spaghetti = "/Users/xiey/developments/da/laps/lapsinstallroot/etc/www/followup_ensemble.sh $domain ensemble $dataroot $window $resolution /Users/xiey/developments/da/laps/lapsinstallroot";
...
my $purger;                                                                          
if (-d "/w3/lapb") {
    $purger = "/usr/bin/perl /Users/xiey/developments/da/laps/lapsinstallroot/etc/purge_w3_fcst2d.pl -t $purge_time $domain $model\n";
    ...
    $purger = "/usr/bin/perl /Users/xiey/developments/da/laps/lapsinstallroot/etc/purge_w3_fcst2d.pl -t $purge_time -d $dataroot $domain $model\n";
...
#     Determine whether to wait
      ...
      if ($opt_a eq "spaghetti") {
          ...
          my $command;
          $command = "$followup $_ /Users/xiey/developments/da/laps/lapsinstallroot";
...
#         $result=system("$followup_xsect $_ /Users/xiey/developments/da/laps/lapsinstallroot");
          $command = "$followup_xsect $_ /Users/xiey/developments/da/laps/lapsinstallroot";
