...
#   find ./lapsprd/lg?     -name "*.lg?" ! -cmin +$MAXAGE -cmin +$MINAGE -print >> $LAPSTAR_TXT
    for file in `ls ./lapsprd/lg?/*.lg?`; do
        ...
        VALIDTIME=`/usr/bin/perl /Users/xiey/developments/da/laps/lapsinstallroot/etc/timeconv.pl -a $FILETIME`
...
if test "$FILES" -ge 2; then
    YYDDDHHMM_M01=`/usr/bin/perl /Users/xiey/developments/da/laps/lapsinstallroot/etc/timeconv.pl -a $YYDDDHHMM -t -60`
    YYDDDHHMM_M02=`/usr/bin/perl /Users/xiey/developments/da/laps/lapsinstallroot/etc/timeconv.pl -a $YYDDDHHMM -t -120`
    YYDDDHHMM_M03=`/usr/bin/perl /Users/xiey/developments/da/laps/lapsinstallroot/etc/timeconv.pl -a $YYDDDHHMM -t -180`
    YYDDDHHMM_M04=`/usr/bin/perl /Users/xiey/developments/da/laps/lapsinstallroot/etc/timeconv.pl -a $YYDDDHHMM -t -240`
    YYDDDHHMM_M05=`/usr/bin/perl /Users/xiey/developments/da/laps/lapsinstallroot/etc/timeconv.pl -a $YYDDDHHMM -t -300`
    YYDDDHHMM_M06=`/usr/bin/perl /Users/xiey/developments/da/laps/lapsinstallroot/etc/timeconv.pl -a $YYDDDHHMM -t -360`
    YYDDDHHMM_M07=`/usr/bin/perl /Users/xiey/developments/da/laps/lapsinstallroot/etc/timeconv.pl -a $YYDDDHHMM -t -420`
    YYDDDHHMM_M08=`/usr/bin/perl /Users/xiey/developments/da/laps/lapsinstallroot/etc/timeconv.pl -a $YYDDDHHMM -t -480`
    YYDDDHHMM_M09=`/usr/bin/perl /Users/xiey/developments/da/laps/lapsinstallroot/etc/timeconv.pl -a $YYDDDHHMM -t -540`
    YYDDDHHMM_M10=`/usr/bin/perl /Users/xiey/developments/da/laps/lapsinstallroot/etc/timeconv.pl -a $YYDDDHHMM -t -600`

    YYDDDHHMM_P01=`/usr/bin/perl /Users/xiey/developments/da/laps/lapsinstallroot/etc/timeconv.pl -a $YYDDDHHMM -t +60`
    YYDDDHHMM_P02=`/usr/bin/perl /Users/xiey/developments/da/laps/lapsinstallroot/etc/timeconv.pl -a $YYDDDHHMM -t +120`
    YYDDDHHMM_P03=`/usr/bin/perl /Users/xiey/developments/da/laps/lapsinstallroot/etc/timeconv.pl -a $YYDDDHHMM -t +180`
    YYDDDHHMM_P04=`/usr/bin/perl /Users/xiey/developments/da/laps/lapsinstallroot/etc/timeconv.pl -a $YYDDDHHMM -t +240`
    YYDDDHHMM_P05=`/usr/bin/perl /Users/xiey/developments/da/laps/lapsinstallroot/etc/timeconv.pl -a $YYDDDHHMM -t +300`
    YYDDDHHMM_P06=`/usr/bin/perl /Users/xiey/developments/da/laps/lapsinstallroot/etc/timeconv.pl -a $YYDDDHHMM -t +360`
    YYDDDHHMM_P07=`/usr/bin/perl /Users/xiey/developments/da/laps/lapsinstallroot/etc/timeconv.pl -a $YYDDDHHMM -t +420`
    YYDDDHHMM_P08=`/usr/bin/perl /Users/xiey/developments/da/laps/lapsinstallroot/etc/timeconv.pl -a $YYDDDHHMM -t +480`
    YYDDDHHMM_P09=`/usr/bin/perl /Users/xiey/developments/da/laps/lapsinstallroot/etc/timeconv.pl -a $YYDDDHHMM -t +540`
    YYDDDHHMM_P10=`/usr/bin/perl /Users/xiey/developments/da/laps/lapsinstallroot/etc/timeconv.pl -a $YYDDDHHMM -t +600`
...
if test "$EXPAND" = noexpand; then
    ...
    echo "/Users/xiey/developments/da/laps/lapsinstallroot/etc/copyremote.sh $LAPSTAR_WWW_TXT $REMOTE_DATA_ROOT exchange_tarfilelist"
          /Users/xiey/developments/da/laps/lapsinstallroot/etc/copyremote.sh $LAPSTAR_WWW_TXT $REMOTE_DATA_ROOT exchange_tarfilelist

    echo " "
    date -u
    echo " "

    echo "/Users/xiey/developments/da/laps/lapsinstallroot/etc/copyremote.sh $LAPSTAR2_TXT    $REMOTE_DATA_ROOT exchange_tarfilelist"
          /Users/xiey/developments/da/laps/lapsinstallroot/etc/copyremote.sh $LAPSTAR2_TXT    $REMOTE_DATA_ROOT exchange_tarfilelist
    ...
    echo "/Users/xiey/developments/da/laps/lapsinstallroot/etc/copyremote.sh $LAPSTAR_WWW_TXT $REMOTE_DATA_ROOT $EXPAND"
          /Users/xiey/developments/da/laps/lapsinstallroot/etc/copyremote.sh $LAPSTAR_WWW_TXT $REMOTE_DATA_ROOT $EXPAND

    echo " "
    date -u
    echo " "

    echo "/Users/xiey/developments/da/laps/lapsinstallroot/etc/copyremote.sh $LAPSTAR2_TXT    $REMOTE_DATA_ROOT $EXPAND"
          /Users/xiey/developments/da/laps/lapsinstallroot/etc/copyremote.sh $LAPSTAR2_TXT    $REMOTE_DATA_ROOT $EXPAND
