...
n_verif_steps=`/usr/bin/perl /Users/xiey/developments/da/laps/lapsinstallroot/etc/read_nl.pl -d $lapsdataroot -n nest7grid.parms -v n_verif_steps`
...
#/Users/xiey/developments/da/laps/lapsinstallroot/etc/verif/verif_fcst_driver.csh /pan1/projects/dlaps/analysis/laps_ci 21600.0  5.75  900 20 > /pan1/projects/dlaps/analysis/laps_ci/log/verif_fcst_driver.log.`date +\%H` 2>&

echo " echo '/bin/csh /Users/xiey/developments/da/laps/lapsinstallroot/etc/verif/verif_fcst_driver.csh $lapsdataroot $model_cycle_time $delay $domain_name $n_verif_steps'                                                     "   >> $script
echo "       /bin/csh /Users/xiey/developments/da/laps/lapsinstallroot/etc/verif/verif_fcst_driver.csh $lapsdataroot $model_cycle_time $delay $domain_name $n_verif_steps > $lapsdataroot/log/verif_fcst_driver.log.`date +\%H`"   >> $script
...
if test "$remote_dataroot" == ""; then   
    ...
    echo "/Users/xiey/developments/da/laps/lapsinstallroot/etc/qsub_wait $script $log.done"
          /Users/xiey/developments/da/laps/lapsinstallroot/etc/qsub_wait $script $log.done
...
#       Rsync the verification data to remote dataroot
        echo "/Users/xiey/developments/da/laps/lapsinstallroot/etc/rsync_out.sh $lapsdataroot dlaps-ms1.fsl.noaa.gov:$remote_dataroot qsub 01:00 8"
              /Users/xiey/developments/da/laps/lapsinstallroot/etc/rsync_out.sh $lapsdataroot dlaps-ms1.fsl.noaa.gov:$remote_dataroot qsub 01:00 8
