...
setenv VERIF_INTVL      `/usr/bin/perl /Users/xiey/developments/da/laps/lapsinstallroot/etc/read_nl.pl -d $LAPS_DATA_ROOT -n nest7grid.parms -v verif_intvl`
setenv N_VERIF_STEPS    `/usr/bin/perl /Users/xiey/developments/da/laps/lapsinstallroot/etc/read_nl.pl -d $LAPS_DATA_ROOT -n nest7grid.parms -v n_verif_steps`
setenv MODEL_FCST_INTVL `/usr/bin/perl /Users/xiey/developments/da/laps/lapsinstallroot/etc/read_nl.pl -d $LAPS_DATA_ROOT -n nest7grid.parms -v model_fcst_intvl`
setenv MODEL_CYCLE_TIME `/usr/bin/perl /Users/xiey/developments/da/laps/lapsinstallroot/etc/read_nl.pl -d $LAPS_DATA_ROOT -n nest7grid.parms -v model_cycle_time`
...
#   Note that this is hardwired for hourly forecast intervals at present
    ...
    if (-e /w3/lapb) then # FAB machine, so we can go back to the short path to /public
        if ($EXE == "obs_driver") then
            /Users/xiey/developments/da/laps/lapsinstallroot/util/fix_net  /scratch2/portfolios/BMC/public /public $LAPS_DATA_ROOT/static/obs_driver.nl
