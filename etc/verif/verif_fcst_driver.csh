...
if ($5 == "") then
    setenv N_VERIF_TIMES `/usr/bin/perl /Users/xiey/developments/da/laps/lapsinstallroot/etc/read_nl.pl -d $LAPS_DATA_ROOT -n nest7grid.parms -v n_verif_steps`
...
if (-d /w3/lapb) then
    ...
    echo /usr/bin/perl /Users/xiey/developments/da/laps/lapsinstallroot/etc/followup_verif.pl -r $LAPS_DATA_ROOT -d $DOMAIN_NAME -y $3 -t $N_VERIF_TIMES
         /usr/bin/perl /Users/xiey/developments/da/laps/lapsinstallroot/etc/followup_verif.pl -r $LAPS_DATA_ROOT -d $DOMAIN_NAME -y $3 -t $N_VERIF_TIMES > $LAPS_DATA_ROOT/log/followup_verif_montage.log
endif
