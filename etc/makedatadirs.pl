...
sub help_sub{
    ...
    print "   --install_root = Root directory of the installed binaries (eg., /Users/xiey/developments/da/laps/lapsinstallroot)\n";
    print "   --dataroot     = Root directory of the installed data (eg., /Users/xiey/developments/da/laps/lapsinstallroot/data)\n";
    print "   --srcroot      = Root directory of the source code    (eg., ..)\n";
