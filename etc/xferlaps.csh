...
#setenv LAPSINSTALLROOT /Users/xiey/developments/da/laps/lapsinstallroot
...
#setenv YYDDDHHMM `/usr/bin/perl /Users/xiey/developments/da/laps/lapsinstallroot/etc/sched_sys.pl -d 0.50 -D $LAPS_DATA_ROOT`
#setenv MONTH     `/usr/bin/perl /Users/xiey/developments/da/laps/lapsinstallroot/etc/sched_sys.pl -d 0.50 -f mm -D $LAPS_DATA_ROOT`
#setenv YYYYMMDD_HHMM `/usr/bin/perl /Users/xiey/developments/da/laps/lapsinstallroot/etc/sched_sys.pl -d 0.50 -f yyyymmdd_hhmm -D $LAPS_DATA_ROOT`
...
if ($MM == "00") then
    echo /Users/xiey/developments/da/laps/lapsinstallroot/etc/tarlapstime.sh $LAPS_DATA_ROOT $YYDDDHHMM $YYYY $MONTH$DATE $FILES $METHOD static $DOMAIN $REMOTE_DATA_ROOT
         /Users/xiey/developments/da/laps/lapsinstallroot/etc/tarlapstime.sh $LAPS_DATA_ROOT $YYDDDHHMM $YYYY $MONTH$DATE $FILES $METHOD static $DOMAIN $REMOTE_DATA_ROOT
else
    echo /Users/xiey/developments/da/laps/lapsinstallroot/etc/tarlapstime.sh $LAPS_DATA_ROOT $YYDDDHHMM $YYYY $MONTH$DATE $FILES $METHOD nostatic $DOMAIN $REMOTE_DATA_ROOT
         /Users/xiey/developments/da/laps/lapsinstallroot/etc/tarlapstime.sh $LAPS_DATA_ROOT $YYDDDHHMM $YYYY $MONTH$DATE $FILES $METHOD nostatic $DOMAIN $REMOTE_DATA_ROOT
endif
