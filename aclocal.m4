...
if test $ptrue = 1 && test $ztrue = 1
then
  AC_MSG_RESULT(Found PNG and Z libraries for Grib2, i.e. $LIBS)
    DEGRIBFLAGS="-DUSE_PNG"
else
  AC_MSG_RESULT(Some Grib2 libraries -lpng -lz were NOT FOUND ...only found >$LIBS<)
    DEGRIBFLAGS=""
fi
